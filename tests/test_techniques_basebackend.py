...
l = logging.getLogger("patcherex.test.test_technique_basebackend")
...
if __name__ == "__main__":
    ...
    logging.getLogger("patcherex.test.test_technique_basebackend").setLevel("INFO")
    if len(sys.argv) > 1:
